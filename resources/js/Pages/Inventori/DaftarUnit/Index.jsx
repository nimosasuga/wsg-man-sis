...
import { ArrowUpRight, Building2, ChevronRight, Plus, Truck, UserRound } from "lucide-react";
                        ...
                        <div className="flex flex-wrap items-stretch gap-3">
                            {canManageInventory && (
                                <Link
                                    ...
                                    className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-[#635bff] px-4 text-sm font-bold text-white shadow-sm shadow-[#635bff]/25 transition hover:bg-[#5148ea]"
                                >
                                    <Plus size={17} />
                                    Tambah unit
                                </Link>
