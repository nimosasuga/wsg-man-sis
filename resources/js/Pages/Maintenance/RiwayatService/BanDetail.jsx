                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex min-w-0 items-center gap-3">
                            ...
                            <div className="min-w-0">
                                ...
                                <h1 className="truncate text-xl font-black text-slate-950">Detail Service Ban</h1>
                            </div>
                        </div>
                        {canManage && <div className="flex flex-wrap gap-2">
                            <Link href={`/riwayat-service-unit/service-ban/${record.id_key}/edit`} className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-violet-600 px-4 text-xs font-black uppercase tracking-wide text-white transition hover:bg-violet-700">
                                <Pencil size={15} />
                                Edit
                            </Link>
