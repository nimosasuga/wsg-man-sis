            ...
            <section className="mb-6 rounded-xl bg-slate-950 p-5 text-white shadow-xl shadow-slate-200">
                ...
                <div className="mt-3 grid gap-4 lg:grid-cols-[1fr_0.8fr_0.8fr_0.5fr]">
                    <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-slate-300">Total profit dari primary, secondary, rental, dan LCL.</p>
                    </div>
            ...
            <div className="overflow-x-auto rounded-xl border border-slate-200 bg-white shadow-sm">
                <table className="min-w-[920px] w-full border-collapse text-left">
                    ...
                    <tbody className="divide-y divide-slate-200">
                        {summaryData.map((item) => (
                            <tr key={item.slug} className="hover:bg-blue-50/50">
                                <td className="border-r border-slate-100 px-4 py-3 text-sm font-black text-slate-800">
                                    {["primary", "secondary", "rental", "lcl"].includes(item.slug) ? (
                                        <Link href={categoryHref(item)} className="hover:text-blue-600">
                                            {item.title}
                                        </Link>
                                    ) : (
                                        item.title
