...
export default function Secondary({
    ...
    const applyFilter = (key, value) => {
        router.get("/profit-unit/secondary", {
            ...filters,
            [key]: value,
        }, {
            preserveState: true,
    ...
    const resetFilters = () => {
        router.get("/profit-unit/secondary", defaultFilters, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const kpiData = [
        ...
        { label: "TOTAL RATA RATA TARIF SECONDARY", value: formatRp(rataTarif ?? record.revenue) },
        { label: "TOTAL RATA RATA BIAYA SECONDARY", value: formatRp(rataBiaya ?? record.cost) },
        { label: "TOTAL KUNJUNGAN SECONDARY", value: formatRp(kunjungan ?? 0) },
    ];
                    ...
                    <div className="flex-1 space-y-6">
                        <section className="rounded-xl border border-slate-200 bg-white shadow-sm shadow-slate-950/5">
                            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
                                <div>
                                    <h2 className="text-sm font-black uppercase tracking-wide text-slate-950">
                                        TABEL PROFIT SECONDARY BY AREA
                                    </h2>
                        ...
                        <section className="rounded-xl border border-slate-200 bg-white shadow-sm shadow-slate-950/5">
                            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
                                <div>
                                    <h2 className="text-sm font-black uppercase tracking-wide text-slate-950">
                                        VIEW PROFIT SECONDARY BY TIPE UNIT
                                    </h2>
                                    <p className="mt-1 text-xs font-semibold text-slate-500">
