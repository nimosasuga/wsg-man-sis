...
export function ProfitFlowPage({ rows = [], config = {}, filterOptions = {}, initialFilters = {}, serverSummary = null }) {
    const page = {
        ...
        showDriver: Boolean(config.showDriver),
        showCreator: Boolean(config.showCreator),
        showType: config.showType !== false,
    ...
    const sortColumns = [
        ...(page.showCreator ? [{ label: "Dibuat Oleh", key: "creator", type: "text" }] : []),
        { label: "Tanggal", key: "tanggal", type: "text" },
        { label: "Area", key: "area", type: "text" },
        ...(page.showDriver ? [{ label: "Driver", key: "driver", type: "text" }] : []),
        { label: page.numberLabel, key: "nopol", type: "text" },
        ...(page.showType ? [{ label: "Tipe", key: "tipe", type: "text" }] : []),
