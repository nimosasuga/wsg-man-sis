...
export default function Rental({
    ...
    const kpiData = [
        { label: "TOTAL TARIF RENTAL", value: formatRp(record.revenue) },
        { label: "TOTAL BIAYA RENTAL", value: formatRp(record.cost) },
        ...
        { label: "TOTAL RATA RATA TARIF RENTAL", value: formatRp(rataTarif ?? record.revenue) },
        { label: "TOTAL RATA RATA BIAYA RENTAL", value: formatRp(rataBiaya ?? 0) },
        { label: "TOTAL KUNJUNGAN RENTAL", value: formatRp(kunjungan ?? 0) },
    ];
                    ...
                    <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
                        <div>
                            ...
                            <h1 className="mt-4 text-2xl font-black text-slate-950">
                                Analitik Profit Rental
                            </h1>
                            <p className="mt-2 max-w-2xl text-sm font-semibold leading-6 text-slate-500">
                                Ringkasan profit, tarif sewa, area, dan tipe unit untuk kebutuhan
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <section className="rounded-xl border border-slate-200 bg-white shadow-sm shadow-slate-950/5">
                            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
                                <div>
                                    <h2 className="text-sm font-black uppercase tracking-wide text-slate-950">
                                        VIEW PROFIT RENTAL BY TIPE UNIT
                                    </h2>
                                    <p className="mt-1 text-xs font-semibold text-slate-500">
