...
export default function Structure({ table, preview = null, addPreview = null }) {
    ...
    return <AdminLayout>
        ...
        <div className="space-y-5">
            ...
            <section className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/70 sm:p-7"><div className="pointer-events-none absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-amber-400 via-violet-500 to-cyan-400" /><span className="inline-flex items-center gap-2 rounded-lg bg-amber-50 px-3 py-1.5 text-xs font-bold text-amber-800"><Settings2 size={15} /> Pengaturan Super Admin</span><h1 className="mt-4 break-all font-mono text-xl font-extrabold tracking-tight text-slate-950 sm:text-2xl">Edit struktur kolom</h1><p className="mt-2 max-w-3xl text-sm leading-6 text-slate-600">Periksa hasil pemeriksaan data sebelum menyimpan. Untuk tanggal gunakan DATE, dan untuk tanggal beserta jam gunakan DATETIME; MySQL menyimpan format internalnya, sedangkan AppSheet menampilkan sesuai lokal pengguna.</p></section>
