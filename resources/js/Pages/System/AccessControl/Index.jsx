            ...
            <div className="space-y-5">
                <section className="rounded-xl bg-slate-950 p-5 text-white shadow-sm sm:p-6">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <div className="inline-flex items-center gap-2 rounded-lg bg-cyan-400/15 px-3 py-1.5 text-xs font-black uppercase tracking-wider text-cyan-200"><ShieldCheck size={15} /> Kontrol Akses</div>
                ...
                <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
                    <div className="flex flex-col gap-3 border-b border-slate-100 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5"><div><div className="flex items-center gap-2"><Users size={18} className="text-cyan-600" /><h2 className="text-sm font-black uppercase text-slate-950">Tabel User</h2></div><p className="mt-1 text-xs font-semibold text-slate-500">Klik row pengguna untuk melihat profil dan mengatur aksesnya.</p></div><Link href="/system/access-control/users/create" className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-cyan-600 px-4 text-sm font-black text-white transition hover:bg-cyan-700"><Plus size={16} />Tambah Pengguna</Link></div>
