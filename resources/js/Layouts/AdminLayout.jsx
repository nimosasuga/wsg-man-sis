...
const menus = [
    ...
    { name: "System Activity Log", icon: Activity, path: "/system/activity-log", superAdminOnly: true },
    {
        name: "CRUD Data",
        icon: Database,
        path: "/module-records",
    ...
    { name: "Mapping Database", icon: Activity, path: "/system/data-health", activePaths: ["/system/data-health"], superAdminOnly: true },
